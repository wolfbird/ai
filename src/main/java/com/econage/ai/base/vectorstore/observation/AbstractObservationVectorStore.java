...
import com.econage.ai.base.vectorstore.observation.DefaultVectorStoreObservationConvention;
...
import com.econage.ai.base.vectorstore.observation.VectorStoreObservationDocumentation;
...
public abstract class AbstractObservationVectorStore implements VectorStore {
	...
	public void add(List<Document> documents) {
		...
		com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext observationContext = this
			.createObservationContextBuilder(com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext.Operation.ADD.value())
			.build();
	...
	public void delete(List<String> deleteDocIds) {
		...
		com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext observationContext = this
			.createObservationContextBuilder(com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext.Operation.DELETE.value())
			.build();
	...
	public List<Document> similaritySearch(SearchRequest request) {
		...
		com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext searchObservationContext = this
			.createObservationContextBuilder(com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext.Operation.QUERY.value())
	...
	/**
	 * Create a new {@link com.econage.ai.base.vectorstore.observation.VectorStoreObservationContext.Builder} instance.
