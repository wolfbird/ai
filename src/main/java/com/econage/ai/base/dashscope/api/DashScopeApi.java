...
import com.econage.ai.base.dashscope.common.DashScopeException;
import com.econage.ai.base.dashscope.common.ErrorCodeEnum;
...
public class DashScopeApi {
    ...
    private ExchangeFilterFunction logRequest() {
        return ExchangeFilterFunction.ofRequestProcessor(request -> {
            ...
            log.info("chat Request Method: {}", request.method());
