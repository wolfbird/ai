...
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletion;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletion.Choice;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionChunk;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionChunk.ChunkChoice;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionFinishReason;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionMessage;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionMessage.ChatCompletionFunction;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionMessage.Role;
import com.econage.ai.base.openai.api.OpenAiApi.ChatCompletionMessage.ToolCall;
import com.econage.ai.base.openai.api.OpenAiApi.LogProbs;
import com.econage.ai.base.openai.api.OpenAiApi.Usage;
...
public class OpenAiStreamFunctionCallingHelper {
	...
	private ChatCompletionMessage merge(ChatCompletionMessage previous, ChatCompletionMessage current) {
		...
		return new ChatCompletionMessage(content, role, name, toolCallId, toolCalls, refusal, audioOutput,reasoningContent);
	}
